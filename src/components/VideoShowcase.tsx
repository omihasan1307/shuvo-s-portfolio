      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-5xl md:text-6xl font-bold mb-4">
            <span className="text-gradient">Featured Showreel</span>
          </h2>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="relative group rounded-2xl overflow-hidden bg-card border border-border aspect-video hover-lift">
            ...
            <iframe
              ...
              src="https://www.youtube.com/embed/6xv14rAOzqs?autoplay=1&mute=1&controls=0&modestbranding=1&showinfo=0&rel=0&iv_load_policy=3&fs=0&loop=1&playlist=6xv14rAOzqs&enablejsapi=1&vq=hd1080"
